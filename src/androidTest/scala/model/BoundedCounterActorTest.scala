package edu.luc.etl.cs313.scala.akkaclickcounter.model
 ...
 */
class BoundedCounterActorTest extends WordSpec with Matchers with MockFactory {

  // TODO update to work with actors
